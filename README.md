...
For this project only the tileserver-php server software was used. 
...
* On windows run:
      ...
      osmosis\bin> .\osmosis.bat --rbf switzerland-latest.osm.pbf --way-key-value keyValueList=natural.cliff --wb cliffs_switzerland_4326.osm.pbf
...
Expanding the values, near line 128: 
    ...
    "retail", "stadium", "pitch", "playground", "theme_park", "bus_station", "zoo","farmyard" }

    landcoverKeys = { wood="wood", forest="wood", wetland="wetland",
    ...
    bare_rock="bare_rock", rock="rock", cliff="cliff", scree="scree",
...
This is a very nice feature. Do the fact that not all buildings have a hight tags which declares the hight of the building but in some case a building-levels tag value. In such a case the value of the buildding-level is taken and calculate for this value an approximate hight.
...
You will find also a link to the *.json URL on the right side in the browser
...
<!DOCTYPE html>
     ...
     <body>
       <div id="map"></div>
       <script>
         var bounds = [[5.31, 45.62], [11.9, 47.88]];
